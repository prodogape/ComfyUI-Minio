...
function addUploadWidget(nodeType, nodeData, widgetName, type = "image") {
...
app.registerExtension({
    name: "MinioHelperSuite.Core",
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData ?.name == "LoadImageFromMinio") {
            addUploadWidget(nodeType, nodeData, "image");
            chainCallback(nodeType.prototype, "onNodeCreated", function () {
                const pathWidget = this.widgets.find((w) => w.name === "image_name");
